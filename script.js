...
const data = [
    {
        ...
        questions: [
            ...
            { text: "4. Попеременно-треугольный итерационный метод", page: 30 },
            { text: "5. Чебышевский набор итерационных параметров", page: 34 },
            { text: "6. Методы вариационного типа", page: 39 },
            { text: "7. Метод вращений поиска собственных значений", page: 57 },
            { text: "8. Степенной метод поиска собственных значений", page: 61 }
        ]
    },
    {
    ...
    },
    {
        ...
        questions: [
            ...
            { text: "4. Многошаговые методы", page: 108 },
